...
export class TopicSelection extends GroupMembership{
 async chooseTopic(p,input){
  demand(p.role==='student',403,'請使用學生帳號選題。');const a=await this.activity(p,input.activityId);demand(a.kind==='w5-personal',400,'這個活動不使用此選題表單。');demand(w5Topic(input.topic),400,'請從本週自選題中選一題。');
