...
const BRIEFS = Object.freeze({
 ...
 'w5-personal': {
  goal:'選一段文字，把重要關係畫清楚，讓別人看圖也能理解。',
  check:'對照原文核對自己的圖；上傳後選一件同學的同題圖作為回應對象，再回自己的作品寫 ORID。'
 },
 'w5-workshop': {
  goal:'把文字中的重要關係畫清楚，讓別人看圖也能理解。',
  check:'請同學先只看圖說回內容，再對照原文，檢查有沒有多畫或漏掉重要關係。'
 },
 'w7-news': {goal:'全組選定一句新聞主張，回研究核對，合作畫一張圖卡。',check:'同題組攤開作品交流；由代表保存最後圖卡與一則ORID交流紀錄。'},
 'w9-check':{goal:'回原文檢查資料能支持什麼，再決定如何修改或保留提案。',check:'保存核對後的來源、原文、自己的提案與 p.1 思考紀錄照片；用 ORID 回看一件課堂中的事、自己的感受，以及未來的學習應用。學科練習留紙本，不必重傳 Classroom。'},
 'w8-proposal':{goal:'以資料說明自己的提案與取捨，回應同學的具體挑戰。',check:'紙本記真實問句與修改或保留的理由；交流後拍 p.2 上傳，不必另寫反思或重傳 Classroom。'},
 'w8-materials':{goal:'讀材料看現況，設定目標、分清障礙與限制，再比較做法提出個人方案。',check:'先自己讀寫，再組內分享；每人保留提案初稿、跨題三人交流的真實問句與自己修改或保留的理由。'},
 'w7': {
  goal:'看懂同一事件的不同呈現，讓自己的圖文有來源、說得準。',
  check:'留意選了哪些資訊、怎麼排列；聽完同學的回饋，再回到來源決定修改或保留。'
 },
 'w15-deck': {
  goal:'讓讀者看懂公共問題的主張、根據，以及資料能支持的範圍。',
