...
const BRIEFS = Object.freeze({
 ...
 'w8-proposal':{goal:'以資料說明自己的提案與取捨，回應同學的具體挑戰。',check:'紙本記真實問句與改留理由；交流後拍 p.2 上傳，不必另寫反思或重傳 Classroom。'},
 'w8-materials':{goal:'讀材料看現況，設定目標、分清障礙與限制，再比較做法提出個人方案。',check:'先自己讀寫，再組內分享；每人保留提案初稿、跨題三人交流的真實問句與自己的改留理由。'},
 'w7': {
